...
job_ocr_verify_kernel_fib_gasnet = {
    ...
    'run-args': '-w -c 1',
    'sandbox': ('inherit0',),
    'env-vars': { 'WORKLOAD_EXEC': '${JJOB_SHARED_HOME}/ocr/ocr-apps/fib/install/x86-pthread-gasnet'}
}
...
job_ocr_verify_kernel_fft_gasnet = {
    ...
    'run-args': '-w -c 1',
    'sandbox': ('inherit0',),
    'env-vars': { 'WORKLOAD_EXEC': '${JJOB_SHARED_HOME}/ocr/ocr-apps/fft/install/x86-pthread-gasnet'}
}
...
job_ocr_verify_kernel_cholesky_gasnet = {
    ...
    'run-args': '${WORKLOAD_EXEC}/cholesky.out.txt ${JJOB_SHARED_HOME}/apps/cholesky/datasets/cholesky_out_1000.txt',
    'sandbox': ('inherit0',),
    'env-vars': { 'WORKLOAD_EXEC': '${JJOB_SHARED_HOME}/ocr/ocr-apps/cholesky/install/x86-pthread-gasnet' }
}
