...
u8 ocrPolicyMsgMarshallMsg(ocrPolicyMsg_t* msg, u8* buffer, ocrMarshallMode_t mode) {
...
u8 ocrPolicyMsgUnMarshallMsg(u8* mainBuffer, u8* addlBuffer,
    ...
    case MARSHALL_ADDL: {
        ...
        ocrPolicyMsgGetMsgSize((ocrPolicyMsg_t*)mainBuffer, &fullSize, &marshalledSize);
