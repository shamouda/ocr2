...
#define PD_TYPE PD_MSG_MGT_RL_NOTIFY
        ...
        u32 runlevel = PD_MSG_FIELD(runlevel);
        u32 action = PD_MSG_FIELD(action);
#undef PD_MSG
#undef PD_TYPE
    ...
    case PD_MSG_MGT_SHUTDOWN:
    {
        if ((msg->srcLocation != curLoc) && (msg->destLocation == curLoc)) {
            ...
            #define PD_TYPE PD_MSG_MGT_RL_NOTIFY
                ...
                PD_MSG_FIELD(runlevel) = RL_RUNNING_USER; //TODO-RL probably should be a higher RL
                PD_MSG_FIELD(action) = RL_ACTION_QUIESCE_COMM;
