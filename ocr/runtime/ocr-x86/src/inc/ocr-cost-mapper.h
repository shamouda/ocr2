...
typedef struct _ocrCostMapperFcts_t {
     ...
     * @param kind[in]           Kind of component
     ...
     */
    u8 (*take)(struct _ocrCostMapper_t *self, ocrLocation_t source, ocrGuid_t *component, ocrGuidKind kind, ocrParamListHint_t *hints, ocrFatGuid_t *costs, ocrFatGuid_t *mappings, u32 properties);
     ...
     * @return 0 on success and a non-zero value on failure
     */
    u8 (*give)(struct _ocrCostMapper_t *self, ocrLocation_t source, ocrGuid_t component, ocrGuidKind kind, ocrParamListHint_t *hints, u32 properties);
