...
/****************************************************/
/* OCR COMPONENT PROPERTIES AND STATES              */
/****************************************************/

#define COMPONENT_PROP_NONE     0x0
#define COMPONENT_PROP_EDT      0x1
#define COMPONENT_PROP_DB       0x2

typedef enum {
    COMPONENT_STATE_ALLOCATED,
    COMPONENT_STATE_PRESCRIBED,
    COMPONENT_STATE_READY,
    COMPONENT_STATE_FREE,
} ocrComponentState_t;
...
typedef struct _ocrComponent_t {
    ...
    ocrComponentState_t state; /**< State of component */
...
typedef struct _ocrComponentFcts_t {
     ...
     *  If *component is not NULL on input, then component simply registers with self.
     *
     *  @param[in] self          Pointer to this component
     *  @param[in] loc           Location that wants to create
     *  @param[in/out] component new component
     *  @param[in] hints         Hints for the create.
     *  @param[in] properties    Properties for the create.
     *
     *  @return 0 on success and a non-zero value on failure
     */
    u8 (*create)(struct _ocrComponent_t *self, ocrLocation_t loc, ocrFatGuid_t *component, ocrGuidKind kind, ocrParamListHint_t *hints, u32 properties);
     ...
     *  @param[in] kind         Kind of element
     *  @param[in] hints        Hints for the insert.
     *  @param[in] properties   Properties for the insert.
     *
     *  @return 0 on success and a non-zero value on failure
     */
    u8 (*insert)(struct _ocrComponent_t *self, ocrLocation_t loc, ocrFatGuid_t component, ocrGuidKind kind, ocrParamListHint_t *hints, u32 properties);
     ...
     *                           If component->guid is NULL_GUID, remove and return a component (implementation specific)
     *  @param[in] kind          Kind of element
     ...
     *  @return 0 on success and a non-zero value on failure
     */
    u8 (*remove)(struct _ocrComponent_t *self, ocrLocation_t loc, ocrFatGuid_t *component, ocrGuidKind kind, ocrParamListHint_t *hints, u32 properties);
     ...
     *  @return 0 on success and a non-zero value on failure
     */
    u8 (*move)(struct _ocrComponent_t *self, ocrLocation_t loc, struct _ocrComponent_t *destination, ocrFatGuid_t component, ocrParamListHint_t *hints, u32 properties);
     ...
     *  @return 0 on success and a non-zero value on failure
     */
    u8 (*split)(struct _ocrComponent_t *self, ocrLocation_t loc, u32 count, u32 *chunks, ocrFatGuid_t *components, ocrParamListHint_t *hints, u32 properties);
     ...
     *  @return 0 on success and a non-zero value on failure
     */
    u8 (*merge)(struct _ocrComponent_t *self, ocrLocation_t loc, u32 count, ocrFatGuid_t *components, ocrParamListHint_t *hints, u32 properties);
...
typedef struct _ocrComponentFactory_t {
     ...
     *
     */
    ocrComponent_t* (*instantiate)(struct _ocrComponentFactory_t * factory, ocrParamListHint_t *hints, u32 properties);
