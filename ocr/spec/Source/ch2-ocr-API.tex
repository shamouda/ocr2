...
\plc{OCR\_EGUIDEXISTS} & The objected referered to by GUID already exists\\
...
%  ocdDbCreate
%
\hypertarget{group__OCRDataBlock_ga8781682157ebe73114af805cc3539a22}{\index{Data-\/block management for O\-C\-R@{Data-\/block management for O\-C\-R}!ocr\-Db\-Create@{ocr\-Db\-Create}}
...
\end{DoxyParamCaption}
)}}\label{group__OCRDataBlock_ga8781682157ebe73114af805cc3539a22}

Request the creation of a data block.

\begin{DoxyParams}[1]{Parameters}
\mbox{\tt out}  & {\em db} & On successful creation, contains the G\-U\-I\-D for the newly created data block. Will be N\-U\-L\-L if the call fails \\
\hline
\mbox{\tt out}  & {\em addr} & On successful creation, contains the 64 bit address if D\-B\-\_\-\-P\-R\-O\-P\-\_\-\-N\-O\-\_\-\-A\-C\-Q\-U\-I\-R\-E is not specified. N\-U\-L\-L otherwise \\
\hline
\mbox{\tt in}  & {\em len} & Size in bytes of the block to allocate. \\
\hline
\mbox{\tt in}  & {\em flags} & Flags to create the data block. Currently, the following properties are supported\-:
\begin{DoxyItemize}
\item \hyperlink{group__OCRTypesDB_ga831208f9dcaeb2560f93988d29d80141}{D\-B\-\_\-\-P\-R\-O\-P\-\_\-\-N\-O\-N\-E}, indicates no specific properties
\item \hyperlink{group__OCRTypesDB_gaaea245d2b799ff575c1c0b9a8a5e3f53}{D\-B\-\_\-\-P\-R\-O\-P\-\_\-\-N\-O\-\_\-\-A\-C\-Q\-U\-I\-R\-E}, the D\-B will be created but not acquired (addr will be N\-U\-L\-L).
\end{DoxyItemize}\\
\hline
\mbox{\tt in,out}  & {\em affinity} & G\-U\-I\-D to indicate the affinity container of this D\-B. This is currently unsupported and N\-U\-L\-L\-\_\-\-G\-U\-I\-D should be passed \\
\hline
\mbox{\tt in}  & {\em allocator} & Allocator to use to allocate within the data block. Supported values are given by \hyperlink{group__OCRTypesDB_gabffd082fa19860aa5a9822beba6b68a5}{ocr\-In\-Db\-Allocator\-\_\-t}\\
\hline
\end{DoxyParams}
...
\begin{DoxyItemize}
\item -\/ \-: successful
\item E\-N\-X\-I\-O \-: affinity is invalid
\item E\-N\-O\-M\-E\-M\-: allocation failed because of insufficient memory
\item E\-I\-N\-V\-A\-L\-: invalid arguments (flags or something else)
\item E\-B\-U\-S\-Y \-: the agent that is needed to process this request is busy. Retry is possible.
\item E\-P\-E\-R\-M \-: trying to allocate in an area of memory that is not allowed
\end{DoxyItemize}
...
%%%%
\descr
On successful creation, the returned memory location will be 8 byte aligned. ocr\-Db\-Create also implicitly
acquires the data-\/block for the calling E\-D\-T unless D\-B\-\_\-\-P\-R\-O\-P\-\_\-\-N\-O\-\_\-\-A\-C\-Q\-U\-I\-R\-E is specified

\begin{DoxyNote}{Note}
The default allocator (N\-O\-\_\-\-A\-L\-L\-O\-C) will disallow calls to ocr\-Db\-Malloc and ocr\-Db\-Free. If an allocator is used, part of the data block's space will be taken up by the allocator's management overhead
\end{DoxyNote}
...
\begin{itemize}
\item \code{enum ocrEventTypes\_t {
OCR\_EVENT\_ONCE\_T, OCR\_EVENT\_IDEM\_T, OCR\_EVENT\_STICKY\_T,
OCR\_EVENT\_LATCH\_T,
OCR\_EVENT\_T\_MAX }}

\item \code{enum ocrLatchEventSlot\_t { OCR\_EVENT\_LATCH\_DECR\_SLOT,
OCR\_EVENT\_LATCH\_INCR\_SLOT }}
...
\hline
\mbox{\tt in}  & {\em takes\-Arg} & True if this event will potentially carry a data block on satisfaction, false othersie \\
\hline
\end{DoxyParams}
...
%%%%
\descr
Events such as O\-N\-C\-E or L\-A\-T\-C\-H are automatically destroyed once they trigger; others, however,
need to be explicitly destroyed by the programmer. This call enables this.
...
parameters and arguments that E\-D\-Ts instanciated from this template will use. It needs to
