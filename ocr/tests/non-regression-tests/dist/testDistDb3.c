...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrEdtCreate(&checkerEdtGuid, checkerEdtTemplateGuid, 0, NULL, 1, &eventGuid,
                 EDT_PROP_NONE, PICK_1_1(&edtHint,affinities[0]), NULL);
    ...
    ocrHintInit( &edtHint, OCR_HINT_EDT_T );
    ocrSetHintValue( & edtHint, OCR_HINT_EDT_AFFINITY, affinities[affinityCount-1] );
    ocrGuid_t addEdtGuid;
    ocrEdtCreate(&addEdtGuid, addEdtTemplateGuid, 1, &rparamv, 1, &dbGuid,
                 EDT_PROP_NONE, PICK_1_1(&edtHint,affinities[affinityCount-1]), NULL);
