...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrGuid_t db1Guid;
    u32 * db1Ptr;
    ocrDbCreate(&db1Guid, (void**) &db1Ptr, sizeof(u32)*10, 0, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
    u32 i = 0;
    while (i < 10) {
        db1Ptr[i] = i;
        i++;
    ...
    ocrEdtCreate(NULL, terminateEdtTemplateGuid, 0, NULL, EDT_PARAM_DEF, ndepv, EDT_PROP_NONE, PICK_1_1(&edtHint,edtAffinity), NULL);
