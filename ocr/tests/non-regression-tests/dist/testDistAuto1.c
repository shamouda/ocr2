...
ocrGuid_t parallel_spawn(u32 paramc, u64 *paramv, u32 depc, ocrEdtDep_t *depv) {
    ...
    u64 args[] = { done_edt, i };
    ocrEdtCreate(&finish_edt, finish_template, 2, args, 0, NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    return NULL_GUID;
}
...
ocrGuid_t mainEdt(u32 paramc, u64 *paramv, u32 depc, ocrEdtDep_t *depv) {
    ...
    ocrEdtCreate(&done_edt, done_template, 0, NULL, N, NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    for(i = 0; i < N; i++) {
        u64 args[] = { done_edt, finish_template, i };
        ocrEdtCreate(&spawn_edt, spawn_template, 3, args, 0, NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    }
    return NULL_GUID;
}
