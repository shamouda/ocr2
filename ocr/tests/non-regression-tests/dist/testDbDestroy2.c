...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrDbCreate(&dbGuidArray, (void **)&dbPtrArray, sizeof(ocrGuid_t), 0, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
    // Set the other db guid in the guid array
    void * dbPtr;
    ocrDbCreate(&dbPtrArray[0], &dbPtr, sizeof(TYPE_ELEM_DB) * NB_ELEM_DB, 0, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
