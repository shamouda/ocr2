...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrGuid_t dbGuid;
    ocrGuid_t * dbPtr;
    ocrDbCreate(&dbGuid, (void **)&dbPtr, sizeof(int) * affinityCount, DB_PROP_SINGLE_ASSIGNMENT, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
    dbPtr[0] = edtAffinity;
    ocrDbRelease(dbGuid);
    ...
    ocrSetHintValue( & edtHint, OCR_HINT_EDT_AFFINITY, queriedDbAffinityGuid );
    ocrGuid_t edtGuid;
    ocrEdtCreate(&edtGuid, remoteEdtTemplateGuid, EDT_PARAM_DEF, NULL, EDT_PARAM_DEF, &dbGuid,
        EDT_PROP_NONE, PICK_1_1(&edtHint,queriedDbAffinityGuid), NULL);
