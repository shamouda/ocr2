...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrEdtCreate(&edtGuid, taskForEdtTemplateGuid, EDT_PARAM_DEF, /*paramv=*/NULL, EDT_PARAM_DEF, /*depv=*/NULL,
                 /*properties=*/0, PICK_1_1(NULL_HINT,NULL_GUID), /*outEvent=*/&output_event_guid);
    ...
    ocrEdtCreate(&chainedEdtGuid, chainedEdtTemplateGuid, EDT_PARAM_DEF, /*paramv=*/NULL, EDT_PARAM_DEF, /*depv=*/NULL,
                 /*properties=*/ EDT_PROP_FINISH, PICK_1_1(NULL_HINT,NULL_GUID), /*outEvent=*/NULL);
    ...
    ocrGuid_t * guid_ref;
    ocrGuid_t db_guid;
    ocrDbCreate(&db_guid,(void **) &guid_ref, sizeof(ocrGuid_t), /*flags=*/DB_PROP_NONE, /*loc=*/PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
    *guid_ref = edtGuid;
