...
ocrGuid_t rootEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    while (i < N) {
        ...
        ocrEdtCreate(&updaterEdtGuid, updaterEdtTemplateGuid, EDT_PARAM_DEF, &nparamv, EDT_PARAM_DEF, &dbGuid, 0, PICK_1_1(NULL_HINT,NULL_GUID), NULL_GUID);
        i++;
    }
    return NULL_GUID;
}
...
ocrGuid_t headEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrEdtCreate(&terminateEdtGuid, terminateEdtTemplateGuid, EDT_PARAM_DEF, /*paramv=*/NULL, EDT_PARAM_DEF, /*depv=*/NULL,
                 0, PICK_1_1(NULL_HINT,NULL_GUID), /*outEvent=*/NULL);
    ...
    ocrEdtCreate(&rootEdtGuid, rootEdtTemplateGuid, EDT_PARAM_DEF, /*paramv=*/NULL, EDT_PARAM_DEF, /*depv=*/NULL,
                 EDT_PROP_FINISH, PICK_1_1(NULL_HINT,NULL_GUID), /*outEvent=*/&outputEventGuid);
    u64 * array;
    ocrGuid_t dbGuid;
    ocrDbCreate(&dbGuid,(void **) &array, sizeof(u64)*N, 0, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
    ocrDbRelease(dbGuid);
