...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrGuid_t edtGuid;
    ocrEdtCreate(&edtGuid, tplGuid, 0, NULL, N+1, NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    ocrEdtTemplateDestroy(tplGuid);

    ocrGuid_t dbGuid;
    u64 * db1Ptr;
    ocrDbCreate(&dbGuid, (void**) &db1Ptr, sizeof(u64), DB_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);
    ocrDbRelease(dbGuid);
    ocrGuid_t evtGuid;
    ...
    ocrEdtCreate(&edt2Guid, tpl2Guid, 2, nparamv, 0,  NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    u32 i = 1;
    while (i < N) {
