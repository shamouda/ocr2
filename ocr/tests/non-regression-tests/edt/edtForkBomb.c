...
ocrGuid_t spawn(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    for(i = 0; i < n; i++) {
        ...
        ocrEdtCreate(&edt, tspawn, 4, args, 0, NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    }
    ocrEdtCreate(&edt, tdec, 1, (u64*)&event, 0, NULL, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    return NULL_GUID;
}
...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrEdtCreate(&edt, tdone , 0, NULL, 1, &event, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    ocrEdtCreate(&edt, tspawn, 4, args, 0, NULL  , EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
