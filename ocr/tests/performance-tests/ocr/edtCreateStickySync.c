...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrGuid_t * dbEvtPtr;
    ocrGuid_t dbEvtGuid;
    ocrDbCreate(&dbEvtGuid, (void **)&dbEvtPtr, (sizeof(ocrGuid_t)*NB_INSTANCES), 0, PICK_1_1(NULL_HINT,NULL_GUID), NO_ALLOC);

    ocrGuid_t terminateEdtGuid;
    ocrEdtCreate(&terminateEdtGuid, terminateEdtTemplateGuid,
                 0, NULL, NB_INSTANCES+1, NULL_GUID, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
    ...
    while (i < NB_INSTANCES) {
        ...
        ocrEdtCreate(&workEdtGuid, workEdtTemplateGuid,
                     1, (u64 *) &dbEvtPtr[i], 0, NULL_GUID, EDT_PROP_NONE, PICK_1_1(NULL_HINT,NULL_GUID), NULL);
        i++;
    }
