...
#
# Event Creation
export CUSTOM_BOUNDS="NB_INSTANCES=1 NB_ITERS=10000000" # 1.1s
...
export CUSTOM_BOUNDS="NB_INSTANCES=1 NB_ITERS=10000000" # 0.7s
...
export CUSTOM_BOUNDS="NB_ITERS=4000000 FAN_OUT=4" # 1.3s
...
export CUSTOM_BOUNDS="NB_ITERS=4000000 FAN_OUT=4" # 1.2s
...
export CUSTOM_BOUNDS="NB_ITERS=3000000 FAN_OUT=4" #
...
export CUSTOM_BOUNDS="NB_ITERS=4000000 FAN_OUT=4" #
