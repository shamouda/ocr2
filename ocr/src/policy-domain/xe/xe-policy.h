...
myStaticAssert(offsetof(ocrPolicyDomain_t, fcts) + offsetof(ocrPolicyDomainFcts_t, switchRunlevel) == PD_SWITCH_RL_OFFSET); // If this fails, go to ss/common/include/rmd-bin-files.h and change PDBEGIN_OFFSET
