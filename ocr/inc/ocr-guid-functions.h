...
#define IS_GUID_NULL          ocrGuidIsNull
#define IS_GUID_UNINITIALIZED ocrGuidIsUninitialized
#define IS_GUID_ERROR         ocrGuidIsError
#define IS_GUID_EQUAL         ocrGuidIsEq
#define IS_GUID_LESS_THAN     ocrGuidIsLt
