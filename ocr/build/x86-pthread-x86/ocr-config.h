...
#define ENABLE_SCHEDULER_HC_0_9
#define ENABLE_COST_MAPPER_HC_NULL
#define ENABLE_COMPONENT_HC_NULL
#else

//default
#define ENABLE_SCHEDULER_HC_1_0
#define ENABLE_COST_MAPPER_HC_1_0
#define ENABLE_COMPONENT_HC_1_0
